...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script><script src="js/custom.js"></script>
	...
	var queIds = [];
	 ...
	 //take the response of this url (in json) and store into var json1
	 $.getJSON( "http://localhost:8081/SpMvcWeb/getTestQuestions", function (json1) {
...
%>				//form button calls 'verify.htm' upon submit/end
