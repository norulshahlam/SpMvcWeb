...
<!-- SUBIMT BUTTON WILL REDIRECT TO addFeedback() in controller -->
						...
						<div class="row">
							<div class="input-field col s12">
								<input id="name" name="name" pattern="[A-Za-z]{2,}"
									...
									data-error="#e1" required> <label for="name">Your
									Name</label>
								<div id="e1"></div>
							</div>
						</div>
						...
						<div class="row">
							<div class="input-field col s12">
								<input id="email" name="email"
									...
									data-error="#e2" required> <label for="email">Your
									Email</label>
								<div id="e2"></div>
							</div>
						</div>
                      ...
                      <option value="3">Online Course</option>
						...
						<div class="row">
							<div class="input-field col s12">
								<input id="code" name="code" type="text" class="validate"
									data-error="#e5"> <label for="code">Code(If
									any)</label>
								<div id="e5"></div>
							</div>
						</div>
						...
						<div class="row">
							<div class="input-field col s12">
								...
								<label for="msg">Feedback msg</label>
								<div id="e4"></div>
							</div>
						</div>
						...
						<div class="row">
							<p>Overall Rating</p>
							<span class="overallRatings"> <input type="radio"
								name="rating" style="display: none" required />
								<div style="clear: both;"></div> <input type="radio"
								id="rating-5" name="rating" value="5" /><label for="rating-5"></label>
								<input type="radio" id="rating-4" name="rating" value="4" /><label
								for="rating-4"></label> <input type="radio" id="rating-3"
								name="rating" value="3" /><label for="rating-3"></label> <input
								type="radio" id="rating-2" name="rating" value="2" /><label
								for="rating-2"></label> <input type="radio" id="rating-1"
								name="rating" value="1" /><label for="rating-1"></label>
							</span>
						</div>
