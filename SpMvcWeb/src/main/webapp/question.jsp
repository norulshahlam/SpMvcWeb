...
<html lang="en">
  ...
  <body>
      ...
      <form name="Questionform" id="question" method="get" action="saveQuestion.htm" >
              ...
              <div class="row">
                <div class="dynamiclabel form-group">
                  <input type="text" id="answer" name="answer" class="form-control" data-error="#e7" required autofocus="" placeholder="Only enter single digit only, 1-4, from the above options..">
